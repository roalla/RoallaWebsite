...
import { CASE_STUDY_SLUGS, isCaseStudySlug } from '@/lib/portfolio-case-studies'
    ...
    <div className="page-shell">
      ...
      <article className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-28 pb-16">
        ...
        <header className="max-w-3xl mb-10">
          <p className="text-sm font-semibold uppercase tracking-wider text-primary-dark">{t('caseStudyEyebrow')}</p>
          <h1 className="mt-3 text-3xl sm:text-4xl font-serif font-extrabold text-slate-900">{name}</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-10 max-w-5xl">
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">{t('caseStudyOutcomeTitle')}</h2>
            <p className="text-slate-700 leading-relaxed">{t(`${prefix}CaseStudy`)}</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">{t('caseStudyHighlightsTitle')}</h2>
