...
const Services = () => {
  ...
  const services = [
    { title: t('s0Title'), desc: t('s0Desc'), features: [t('s0F1'), t('s0F2'), t('s0F3')], ideal: t('s0Ideal'), icon: serviceIcons[0], ctaHref: '/assessment' as const },
    { title: t('s1Title'), desc: t('s1Desc'), features: [t('s1F1'), t('s1F2'), t('s1F3')], ideal: t('s1Ideal'), icon: serviceIcons[1], ctaHref: '/contact' as const },
    { title: t('s2Title'), desc: t('s2Desc'), features: [t('s2F1'), t('s2F2'), t('s2F3')], ideal: t('s2Ideal'), icon: serviceIcons[2], ctaHref: '/contact' as const },
    { title: t('s3Title'), desc: t('s3Desc'), features: [t('s3F1'), t('s3F2'), t('s3F3')], ideal: t('s3Ideal'), icon: serviceIcons[3], ctaHref: '/assessment' as const },
    { title: t('s4Title'), desc: t('s4Desc'), features: [t('s4F1'), t('s4F2'), t('s4F3')], ideal: t('s4Ideal'), icon: serviceIcons[4], ctaHref: '/contact' as const },
    { title: t('s5Title'), desc: t('s5Desc'), features: [t('s5F1'), t('s5F2'), t('s5F3')], ideal: t('s5Ideal'), icon: serviceIcons[5], ctaHref: '/contact' as const },
  ]
