...
const EMAIL_LABELS: Record<string, string> = {
  ...
  'websiteGoal_custom-platform': 'Custom platforms & digital tools',
  websiteGoal_automation: 'Workflow automation',
  websiteGoal_integration: 'System integration',
