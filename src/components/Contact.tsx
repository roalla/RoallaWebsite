        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white rounded-xl p-8 shadow-card border border-slate-200 text-center hover:shadow-card-hover hover:border-primary/25 transition-all duration-300"
            >
