...
export default function LoginForm() {
  ...
  const errorMessage =
    ...
    (error === 'Callback' ? t('oauthErrorCallback') : null) ||
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center py-10 px-4 relative">
      {isRedirecting && (
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <section className="lg:col-span-7 bg-surface-card rounded-2xl shadow-2xl border border-white/15 p-8 sm:p-10">
            ...
            <div className="mb-10">
              <h2 id="login-title" className="text-2xl font-bold text-white">{t('signIn')}</h2>
