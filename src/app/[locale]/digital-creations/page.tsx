...
export const metadata = {
  ...
  description: 'The Business Cocoon, Soaring Puck, True North Audit, Preflight, and more — practical tools from 30+ years of business enablement experience. Built by ROALLA.',
  alternates: {
