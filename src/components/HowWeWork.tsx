  ...
  return (
    <section id="how-we-work" className="section-padding bg-black py-20 lg:py-28">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <Reveal key={step.number} delayMs={index * 100} className="relative">
                {index < steps.length - 1 && (
                  <div
                    className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-primary to-primary-dark z-0"
        ...
        <Reveal delayMs={400} className="mt-16 text-center">
