      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="lg:pr-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-6">{t('ourStory')}</h3>
          ...
          <div>
            <div className="w-full h-80 bg-gradient-to-br from-primary-lighter to-gray-100 dark:from-primary-dark/20 dark:to-gray-800 rounded-xl shadow-2xl flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t('ourTeam')}</h3>
                <p className="text-gray-700 dark:text-gray-200 mt-2">{t('teamSubtitle')}</p>
              </div>
            </div>
          </div>
        </div>
