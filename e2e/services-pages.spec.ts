...
test.describe('Service pages', () => {
  ...
  test('new service architecture routes are bilingual and reachable', async ({ page }) => {
    for (const route of [
      'digital-products',
